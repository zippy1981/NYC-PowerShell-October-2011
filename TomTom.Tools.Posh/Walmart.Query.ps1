...
Add-Type -Path "..\EventLogExamples\bin\MongoDB.Bson.dll";
Add-Type -Path "..\EventLogExamples\bin\MongoDB.Driver.dll";
...
New-Object PSOBject -Property ($collection.FindOne($query)).ToHashTable() 